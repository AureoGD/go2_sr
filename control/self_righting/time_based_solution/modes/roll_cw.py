...
class RollCW(BaseTimeController):
    ...
    def __init__(self, **kwargs):
        ...
        references = [
            np.array([[-0.6, 1.5, -2.0, -0.6, 1.3, -2.6, -0.6, 1.5, -2.0, 0.4, 3.75, -1.5]]),
            np.array([[-0.4, 1.5, -2.0, -0.6, 1.3, -2.6, -0.4, 1.5, -2.0, 0.5, 3.75, -1.5]]),
            np.array([[0.3, 1.5, -2.0, -0.6, 1.3, -2.6, 0.3, 1.5, -2.0, 0.9, 3.75, -1.5]])
        ]
