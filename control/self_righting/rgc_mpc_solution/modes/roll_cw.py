...
class RollCW(BaseRGCController):
    ...
    def __init__(self, robot_states, **kwargs):
        ...
        self.nc = 35  # qr (12, 1), CoM projection (6, 1), dqr (12, 1), GRF
    ...
    def update_model(self):
        ...
        pivot_fr = self.pin_engine.frame_pos("FR", "thigh")
        pivot_rr = self.pin_engine.frame_pos("RR", "thigh")
