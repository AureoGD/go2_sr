...
class ProneCW(BaseTimeController):
    ...
    def __init__(self, **kwargs):
        ...
        references = [
            np.array([[1.05, 1.5, -2.7, -0.85, 1.4, -2.7, 1.05, 1.50, -2.7, -0.9, 1.4, -2.7]]).T,
            np.array([[1.05, 1.5, -2.7, -0.85, 1.4, -2.7, 0.00, 1.55, -2.7, -0.9, 1.4, -2.7]]).T,
            np.array([[0.00, 1.5, -2.7, -0.85, 1.4, -2.7, 0.00, 1.55, -2.7, -0.9, 1.4, -2.7]]).T,
            np.array([[0.00, 1.4, -2.7, -0.00, 1.4, -2.7, 0.00, 1.40, -2.7, -0.0, 1.4, -2.7]]).T
        ]
